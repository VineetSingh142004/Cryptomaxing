...
export function buildThresholdCalibrationReport(ranked: ScanCandidate[]): ThresholdCalibrationReport {
  const strategies: StrategyCalibrationRow[] = [
    ...
    row("Volatility Compression Breakout", "breakoutScore", 65, ranked, (c) => c.breakoutScore ?? 0),
    ...
    row("Trend Pullback Continuation", "trendScore", 55, ranked, (c) => c.trendScore ?? 0),
